...
<?php include("header.php"); ?>
  	...
  	<div class="container" id="homepagecontainer">
    	<h1 style="font-family: 'Roboto';font-size: 57px; text-shadow: 0 0 1px #000000,
																		0 0 2px #000000,
																		0 0 3px #000000,
																		0 0 4px #000000,
																		0 0 5px #000000,
																		...
																		0 0 23px #0000ff,
																		0 0 25px #0000ff,
																		0 0 26px #0000ff;	color:white;">Secret Files</h1>
			<br>
			<br>
    		<p><strong style="color:white; font-size: 17px; font-weight:350; text-shadow: 0 0 1px #000000,
														0 0 2px #000000,
														0 0 3px #000000,
														0 0 4px #000000,
														0 0 5px #000000,
														...
														0 0 7px #000000,
														0 0 8px #000000,
														0 0 9px #000000;">Store your files permanently and securely!! </strong></p>
		<div id="error"><?php  if($error!=""){echo '<div class="alert alert-danger" role="alert">'.$error.'</div>';} ?></div>
		<form method="post" action="" id="loginform">
				<p style="color:white; font-size: 17px; font-weight:350; text-shadow: 0 0 1px #000000,
														0 0 2px #000000,
														0 0 3px #000000,
														0 0 4px #000000,
														0 0 5px #000000,
														...
														0 0 7px #000000,
														0 0 8px #000000,
														0 0 9px #000000;">Log in using your username and password.</p>
				...
				<div class="checkbox">
					<label style="color:white; font-size: 17px; font-weight:350; text-shadow: 0 0 1px #000000,
														0 0 2px #000000,
														0 0 3px #000000,
														0 0 4px #000000,
														0 0 5px #000000,
				...
				<p><a class="toggleforms btn btn-success">Sign up</a></p>
			</form>
			<form method="post" action="" id="signupform">
				<p style="color:white; font-size: 17px; font-weight:350; text-shadow: 0 0 1px #000000,
														...
														0 0 7px #000000,
														0 0 8px #000000,
														0 0 9px #000000;">Interested? sign up now.</p>
				<fieldset class="form-group">
					<input type="email" class="form-control" name="email" placeholder="Enter your mail here!">
				</fieldset>
				<fieldset class="form-group">
				...
				<p><a class="toggleforms btn btn-success">Log In</a></p>
			</form>
    </div>
